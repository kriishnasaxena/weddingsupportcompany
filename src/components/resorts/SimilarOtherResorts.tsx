...
interface SimilarOtherResortsProps {
...
export const SimilarOtherResorts: React.FC<SimilarOtherResortsProps> = ({
  currentResortId,
  currentRooms,
  currentLocation,
  savedBudgetsMap,
    ...
    const fetchOtherResorts = async () => {
      try {
        ...
        snap.forEach((docSnap) => {
          ...
          const location = data.core_location || data.core_city || '';
        ...
        console.error('Error fetching other location resorts:', e);
      } finally {
        setLoading(false);
      }
    };
          ...
          {resorts.map((resort) => (
            ...
            >
              ...
              <div className="p-3 flex-1 flex flex-col justify-between">
                ...
                {resort.savedBudget && (
                  <div className="bg-[#6B0D24]/10 text-[#6B0D24] py-1 px-2.5 rounded-lg text-[10px] font-black text-center border border-[#6B0D24]/20 mt-2 truncate w-full">
